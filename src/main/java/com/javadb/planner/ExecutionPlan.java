...
public sealed interface ExecutionPlan
     ...
     */
    record IndexRangeScan(Statement statement, String indexColumn, int low, int high) implements ExecutionPlan {}
    ...
    /** INSERT / UPDATE / DELETE — always full-scan today; DML planner is future work. */
